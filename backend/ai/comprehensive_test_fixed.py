...
def test_complete_pipeline():
    ...
    try:
        ...
        print("🧠 Step 6: Initializing Multi-Modal Fusion Network...")        # Get feature dimensions
        ...
        print(f"🔍 Debug: Metadata dimensions: {metadata_dims}")
        print(f"🔍 Debug: Numerical features shape: {metadata_features['numerical_features'].shape}")
        
        model = MultiModalFusionNetwork(
            vocab_size=text_vocab_size,
            text_embed_dim=128,
            text_hidden_dim=64,
            numerical_dim=metadata_dims.get('numerical', 34),
