...
class CommitClassificationService:
    def __init__(self):
        # Đường dẫn tới thư mục gốc của project (KLTN04)
        project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
        self.data_dir = os.path.join(project_root, "ai", "model", "multifusion", "data")
        self.model_path = os.path.join(project_root, "ai", "model", "multifusion", "multifusionV2.pth")
